#Age Calculator project in Python. Install tkinter module by terminal or cmd. Thank you very much.
...
if __name__ == '__main__':
    ...
    #This project can be distributed by anyone to everyone. Sharing is caring.